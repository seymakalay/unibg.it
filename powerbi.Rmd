...
## Last Year 
<!--\1 DIVIDE(_rslt, _currOffset <= 0 || _currYr <= 0) -->
```
LY = 
...
<!--\1 DIVIDE( SELECTEDMEASURE() - _rslt,_cy <= 0 && _rslt) -->
```
CY vs LY = 
...
## Current vs Last Year %
<!--\1 DIVIDE( DIVIDE( SELECTEDMEASURE() - _rslt, ABS(_rslt) ) , _cy <= 0) -->
```
CY vs LY% = 
var _currOffset = MAX( 'Calendar'[Sequential Fiscal Month] )
var _offsetBegin = MIN( 'Calendar'[Sequential Fiscal Month] ) - 12
