...
Before creating our 'Fact FX' data flow we need to create a few dataflow.

Let\'s start producing our data flows.

'Fiscal Date' data flow.
```
```


##'Fiscal Month End' data flow.
```
```


##'Fiscal Month Start' data flow.
```
```
